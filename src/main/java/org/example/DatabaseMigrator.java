...
DatabaseMigrator {
    public static void main(String[] args) throws IOException {
        ...
        final String PROPERTIES_FILE = "C:\\Users\\1\\Idea Project\\REST-API-master\\src\\main\\resources\\flyway.properties";
...
Properties properties = new Properties();
        ...
        Flyway flyway = Flyway.configure().dataSource(url, username, password).locations(locations).load();
        flyway.migrate();
    }
}
